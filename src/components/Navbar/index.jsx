                    ...
                    <div key={item.name} className="relative group navbar">
                      {item.subItems ? (
                        <>
                          ...
                          <div className="absolute left-0 hidden -mt-2 pt-2.5 w-64 bg-transparent origin-top-left group-hover:block z-50" >
                            <div className=" bg-blue-900 border border-gray-200 rounded-md shadow-lg">
                              <div className="py-1 ">
